...
try {
    ...
    $ClientSpaces = PodioItem::filter(13941091);

    foreach($ClientSpaces as $client){
        $SpaceID = $client->fields['workspace-id']->values;
        $HelpDeskAppID = $client->fields['app-id']->values;
