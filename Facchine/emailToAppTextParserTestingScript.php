...
try{
    ...
    $sendMessage = $client->messages->create($recipientCellNumber,
        array(
...
//        $bathCount = trim($bathCount[1], " ");
    ...
    PodioComment::create('item', $itemId, array(
        'value' => "Text message sent to Facchine Agent. ($agentCellNumber)")
    );
...
//
//$emailToLeadBody = str_replace('{{leadEmailAddress}}', $leadEmailAddress, $emailToLeadBody);
//$emailToLeadBody = str_replace('{{leadPhoneNumber}}', $leadPhoneNumber, $emailToLeadBody);
//$emailToLeadBody = str_replace('{{newLeadItemTitle}}', $newLeadItemTitle, $emailToLeadBody);
//$emailToLeadBody = str_replace('{{newLeadItemLink}}', $newLeadItemLink, $emailToLeadBody);
//$emailToLeadBody = str_replace('{{propertyAddress}}', $propertyAddress, $emailToLeadBody);
//
//
//$emailToAgentSubject = str_replace('{{mlsNumber}}', $mlsNumber, $emailToAgentSubject);
//$emailToAgentSubject = str_replace('{{leadFirstName}}', $leadFirstName, $emailToAgentSubject);
//$emailToAgentSubject = str_replace('{{agentFullName}}', $agentFullName, $emailToAgentSubject);
//$emailToAgentSubject = str_replace('{{sourceOfLeadName}}', $sourceOfLeadName, $emailToAgentSubject);
//$emailToAgentSubject = str_replace('{{agentCellNumber}}', $agentCellNumber, $emailToAgentSubject);
//$emailToAgentSubject = str_replace('{{leadEmailAddress}}', $leadEmailAddress, $emailToAgentSubject);
//$emailToAgentSubject = str_replace('{{leadPhoneNumber}}', $leadPhoneNumber, $emailToAgentSubject);
//$emailToAgentSubject = str_replace('{{agentEmail}}', $agentEmail, $emailToAgentSubject);
//$emailToAgentSubject = str_replace('{{newLeadItemTitle}}', $newLeadItemTitle, $emailToAgentSubject);
//$emailToAgentSubject = str_replace('{{newLeadItemLink}}', $newLeadItemLink, $emailToAgentSubject);
//$emailToAgentSubject = str_replace('{{propertyAddress}}', $propertyAddress, $emailToAgentSubject);
//
//$emailToAgentBody = str_replace('{{leadFirstName}}', $leadFirstName, $emailToAgentBody);
//$emailToAgentBody = str_replace('{{leadEmailAddress}}', $leadEmailAddress, $emailToAgentBody);
//$emailToAgentBody = str_replace('{{leadPhoneNumber}}', $leadPhoneNumber, $emailToAgentBody);
//$emailToAgentBody = str_replace('{{agentFullName}}', $agentFullName, $emailToAgentBody);
//$emailToAgentBody = str_replace('{{agentEmail}}', $agentEmail, $emailToAgentBody);
//$emailToAgentBody = str_replace('{{agentCellNumber}}', $agentCellNumber, $emailToAgentBody);
//$emailToAgentBody = str_replace('{{mlsNumber}}', $mlsNumber, $emailToAgentBody);
//$emailToAgentBody = str_replace('{{propertyAddress}}', $propertyAddress, $emailToAgentBody);

//        $filePathToDelete = array();
//        $files = $item->files;
...
//
//                $fields["attachment[$key]"] = curl_file_create($path_to_file, 'application/pdf', $fileName);
//                array_push($filePathToDelete, $path_to_file);
//            }
//        }
//        //delete file
//        foreach ($filePathToDelete as $deleteThis) {
//            unlink($deleteThis);
//        }